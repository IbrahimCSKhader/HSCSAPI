...
public class LaboratoryTechnologistsService : ILaboratoryTechnologistsService
{
    ...
    public Task<IActionResult> DeactivateAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return SetActiveStateAsync(laboratoryTechnologistId, false, user, cancellationToken);
    }
    ...
    public Task<IActionResult> ActivateAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return SetActiveStateAsync(laboratoryTechnologistId, true, user, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!await CanCurrentUserManageLaboratoryTechnologistAsync(technologist, user, cancellationToken))
        {
            return ForbiddenAction("You are not allowed to change this laboratory technologist's active state.");
        }
