...
public interface IClinicsService
{
    ...
    Task<IActionResult> DeactivateAsync(Guid clinicId, CancellationToken cancellationToken = default);
    Task<IActionResult> ActivateAsync(Guid clinicId, CancellationToken cancellationToken = default);
